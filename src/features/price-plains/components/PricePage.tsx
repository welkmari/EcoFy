...
import { Lightning, Shield, Sparkle } from '@phosphor-icons/react';
    ...
    <div className="min-h-screen bg-base px-4 sm:px-6 py-12 sm:py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12">
          <p className="text-xs text-text-muted uppercase tracking-widest mb-3">Planos</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          {PERKS.map(({ icon: Icon, title, description }) => (
            ...
            >
              <div className="p-3 rounded-xl bg-base border border-border-default text-purple-400 flex-shrink-0">
                <Icon size={20} />
              </div>
              <div>
